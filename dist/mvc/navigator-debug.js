define("#mix/core/0.3.0/mvc/navigator-debug", [ "mix/core/0.3.0/base/reset-debug", "mix/core/0.3.0/base/class-debug", "controller-debug" ], function(require, exports, module) {
    require("mix/core/0.3.0/base/reset-debug");
    var Class = require("mix/core/0.3.0/base/class-debug"), Controller = require("controller-debug"), win = window, doc = win.document, head = doc.head, undef = undefined, scriptCache = {};
