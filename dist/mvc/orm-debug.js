define("#mix/core/0.3.0/mvc/orm-debug", [ "mix/core/0.3.0/base/reset-debug", "mix/core/0.3.0/base/class-debug", "model-debug" ], function(require, exports, module) {
    require("mix/core/0.3.0/base/reset-debug");
    var Class = require("mix/core/0.3.0/base/class-debug"), Model = require("model-debug");
    ORM = Model.extend({
        test: function() {
